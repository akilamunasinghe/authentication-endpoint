...
<body class="background-blue" onload="setCookieByParam();">
...
<div class="container-fluid body-wrapper">
    ...
    <div class="background-blue row">
        <div class="col-md-12">
            ...
            <!-- content -->
            <div class="background-blue container col-xs-10 col-sm-6 col-md-6 col-lg-3 col-centered wr-content wr-login col-centered">
                <div>
                    <div class="clearfix"></div>

                    <div class="container">
                        <div class="row">
                            <div class="icon-color span12">
